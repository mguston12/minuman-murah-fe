...
<template>
  <div class="py-12 px-4 sm:px-6 lg:px-8 flex flex-col justify-center items-center">
    <div class="w-full max-w-md space-y-6">
      ...
      <div class="bg-white py-8 px-6 shadow-sm border border-gray-100 rounded-2xl sm:px-8 space-y-5">
        ...
        <div v-if="localError"
          ...
          <button @click="clearError" type="button" class="text-red-600 font-bold ml-2">
            &times;
          </button>
        </div>
        ...
        <form @submit.prevent="handleLogin" class="space-y-4">
          ...
          <div>
            ...
            <div class="relative rounded-lg shadow-sm">
              ...
              <input id="password" v-model="formData.password" :type="showPassword ? 'text' : 'password'" required
                :disabled="isLoading" placeholder="Masukkan kata sandi"
              ...
              <button type="button" @click="togglePassword" :disabled="isLoading"
          ...
          <div class="flex items-center justify-between text-xs">
            ...
            <router-link to="/forgot-password" class="font-medium text-[#E25C38] hover:underline">
              Lupa kata sandi?
            </router-link>
          </div>
        ...
        <div class="text-center text-xs text-gray-500 pt-2">
          Belum punya akun?
          <router-link to="/register" class="font-semibold text-[#E25C38] hover:underline ml-1">
            Daftar sekarang
          </router-link>
        </div>
      </div>
